...
.controller('WelcomeCtrl', ['$scope', '$firebase', 'CommonProp', function($scope, $firebase, CommonProp) {
    ...
    $scope.editPost = function(id) {
        console.log(id);
        var firebaseObj = new Firebase("https://angularpress.firebaseio.com/Articles/" + id);
    ...
    $scope.update = function() {
        ...
        var fb = new Firebase("https://angularpress.firebaseio.com/Articles/" + $scope.postToUpdate.$id);
    ...
    $scope.confirmDelete = function(id) {
        var fb = new Firebase("https://angularpress.firebaseio.com/Articles/" + id);
        var article = $firebase(fb);
    ...
    $scope.deletePost = function() {
        var fb = new Firebase("https://angularpress.firebaseio.com/Articles/" + $scope.postToDelete.$id);
        var article = $firebase(fb);
